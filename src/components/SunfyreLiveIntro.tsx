...
export const SunfyreLiveIntro: React.FC<SunfyreLiveIntroProps> = ({ onComplete }) => {
  ...
  return (
    <div
      ...
      className={`fixed inset-0 z-[9999] bg-[#070709] flex flex-col items-center justify-center overflow-hidden select-none transition-opacity duration-700 ${
    ...
    >
      ...
      <div className="absolute top-6 left-6 right-6 flex items-center justify-between z-50">
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-zinc-400 hover:text-[#E5B842] text-xs font-mono transition-all backdrop-blur-md cursor-pointer"
            title={isMuted ? 'Unmute Sound' : 'Mute Sound'}
          >
            {isMuted ? <VolumeX className="w-4 h-4" /> : <Volume2 className="w-4 h-4 text-[#E5B842]" />}
          ...
          {isSuperAdmin && (
            <>
              <label className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 hover:bg-[#E5B842]/20 border border-white/10 hover:border-[#E5B842]/50 text-zinc-300 hover:text-[#E5B842] text-xs font-mono transition-all backdrop-blur-md cursor-pointer">
              ...
              {isCustom && (
                <button
                  ...
                  className="flex items-center gap-1 px-2.5 py-1.5 rounded-full bg-white/5 hover:bg-red-500/20 border border-white/10 text-zinc-400 hover:text-red-300 text-xs font-mono transition-all backdrop-blur-md cursor-pointer"
        ...
        <button
          onClick={handleEnter}
          className="px-4 py-1.5 rounded-full bg-white/5 hover:bg-[#E5B842]/20 border border-white/10 hover:border-[#E5B842]/40 text-zinc-400 hover:text-white text-xs font-mono tracking-wider uppercase transition-all backdrop-blur-md cursor-pointer flex items-center gap-1.5"
        >
          <span>Skip Intro</span>
          <span className="text-[10px] text-zinc-500 bg-black/40 px-1.5 py-0.5 rounded font-mono">ESC</span>
        </button>
      </div>
      ...
      <div
        ...
        className="relative z-20 flex flex-col items-center text-center px-4 max-w-2xl"
      >
        {/* Modern Sunfyre Golden Dragon 3D Crest */}
        <div
          className={`relative group mb-8 transition-all duration-1000 ${
        ...
        >
          ...
          <div className="relative w-44 h-44 sm:w-56 sm:h-56 rounded-full p-1.5 bg-gradient-to-tr from-[#946e1a] via-[#f7d779] to-[#80590a] shadow-[0_0_50px_rgba(229,184,66,0.35)]">
          ...
          {isSuperAdmin && (
            <div className="mt-3 flex items-center justify-center">
              <label className="text-[10px] font-mono text-zinc-400 hover:text-[#E5B842] cursor-pointer flex items-center gap-1.5 bg-black/60 px-3 py-1 rounded-full border border-white/10 hover:border-[#E5B842]/40 transition-all">
                <Upload className="w-3 h-3 text-[#E5B842]" />
                <span>{isCustom ? 'Custom logo active • Click to change' : 'Super Admin: Click to upload your custom logo'}</span>
                <input
                  type="file"
                  accept="image/*"
                  className="hidden"
        ...
        >
          ...
          <h1 className="text-4xl sm:text-6xl font-serif font-black tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-[#FFF5D1] via-[#E5B842] to-[#A87B19] drop-shadow-[0_4px_24px_rgba(229,184,66,0.3)]">
            MiniBid
          </h1>

          {/* Sunfyre Corporate Signature */}
          <div className="flex items-center justify-center gap-2 text-xs sm:text-sm font-mono uppercase tracking-[0.25em] text-[#E5B842]">
            <span className="w-8 h-[1px] bg-gradient-to-r from-transparent to-[#E5B842]" />
            <span className="font-bold drop-shadow-[0_2px_8px_rgba(229,184,66,0.4)]">
              Powered by Sunfyre General Trading
            </span>
            <span className="w-8 h-[1px] bg-gradient-to-l from-transparent to-[#E5B842]" />
          </div>

          <p className="text-xs text-zinc-400 font-sans tracking-wide max-w-md mx-auto pt-1 leading-relaxed">
      ...
      <div className="absolute bottom-6 flex items-center gap-6 text-[11px] font-mono text-zinc-500 z-30">
        <span className="flex items-center gap-1.5">
          <Shield className="w-3.5 h-3.5 text-[#E5B842]" /> Zero Double-Spend Protected
        </span>
        <span className="hidden sm:inline">•</span>
        <span className="hidden sm:inline">Certified Reverse Auction Architecture</span>
        <span className="hidden sm:inline">•</span>
